...
4. **`docs/sentry/SENTRY_ERROR_HANDLING.md`** - Pełna dokumentacja
5. **`docs/firebase/FIREBASE_PERFORMANCE.md`** - Dokumentacja performance tracking
6. **`docs/sentry/SENTRY_ADVANCED_FEATURES.md`** - 🆕 Source Maps, Release Tracking, User Feedback
7. **`src/utils/sentryExamples.js`** - Przykłady użycia
...
Zobacz [`sentryExamples.js`](../../src/utils/sentryExamples.js) dla 10+ przykładów użycia.

## 🆘 Wsparcie

1. **Quick Start**: Ten plik!
2. **Podstawy**: [`SENTRY_ERROR_HANDLING.md`](./SENTRY_ERROR_HANDLING.md)
3. **Performance**: [`FIREBASE_PERFORMANCE.md`](../firebase/FIREBASE_PERFORMANCE.md)
4. **Zaawansowane**: 🆕 [`SENTRY_ADVANCED_FEATURES.md`](./SENTRY_ADVANCED_FEATURES.md)
5. **Przykłady**: [`sentryExamples.js`](../../src/utils/sentryExamples.js)

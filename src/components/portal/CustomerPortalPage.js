...
const CustomerPortalPage = () => {
  ...
  const renderContent = () => {
    ...
    switch(activeTab) {
      ...
      case 'invoices':
        return <Invoices customerId={portalData.customerId} customerName={portalData.customerName} />;
      case 'transport':
        return <Transport customerId={portalData.customerId} customerName={portalData.customerName} />;
      case 'products':
        return (
          <ProductCatalog 

...
const UnloadingReportFormPage = () => {
  ...
  const unloadingInfoRef = useRef(null);
  const goodsInfoRef = useRef(null);
  const formSections = [
    { label: t('sections.identification'), ref: identificationRef },
    { label: t('inventoryForms.unloadingReport.section2Title'), ref: unloadingInfoRef },
    { label: t('inventoryForms.unloadingReport.section3Title'), ref: goodsInfoRef },
  ];
      ...
      <Container maxWidth="md" sx={getFormContainerStyles()}>
        <Paper sx={getFormPaperStyles(theme)}>
          ...
          <Box sx={{ mb: 2 }}>
            ...
            <Box ref={unloadingInfoRef} sx={getFormSectionStyles(theme, 'warning')}>
